...
# mhy_name = soup.find('span',class_ = 'cell name item_3')
# span_all = soup.find_all("span")

# result = soup.find_all('span',class_ = 'cell name item_3')
# result1 = result.text
# print(result1)


result = soup.find('span',attrs={"class":'cell name item_3'})
print(result)